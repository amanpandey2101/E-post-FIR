...
export default class RegisterDetails extends Component {
  ...
  render() {
    ...
    return (
      <div className="flex bg-white rounded-2xl justify-center pt-5 pb-5 w-[20vw]  max-[400px]:w-[80vw] shadow-md ">
        <div className="Card flex  flex-col left-5">
          ...
          <form className="space-y-4 p-3 w-[15vw] max-[768px]:w-[50vw] max-[400px]:w-[80vw]" action="#">
            <div>
              <input
                type="text"
                onChange={(e) => {
