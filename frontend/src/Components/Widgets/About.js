      ...
      <div class="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
            <div class="flex lg:flex-row flex-col justify-between gap-8 pt-12">
                ...
                <div class="w-full lg:w-8/12 lg:pt-8">
                    <div class="grid sm:grid-cols-2 grid-cols-1 lg:gap-4 shadow-lg rounded-2xl">
                        ...
                        <div class="p-4 pb-6 flex justify-center flex-col items-center">
                            <img class="md:block h-60 md:h-[35vh] rounded-xl w-55 md:w-fit" src={require('./images/anant.jpg')} alt="" />
                            {/* <img class="md:hidden block object-cover object-bottom" src={require('./images/amity_uniform_1-min-removebg-preview.png')} alt="" /> */}
                            <p class="font-medium text-xl leading-5 text-gray-800 dark:text-white mt-4">Anant Kumar</p>
                        </div>
            ...
            <div class="flex flex-col lg:flex-row justify-between gap-8">
                ...
                <div class="w-full lg:w-8/12 ">
                    <img class="w-full h-fit pt-5 rounded-2xl" src="https://i.ibb.co/FhgPJt8/Rectangle-116.png" alt="A group of People" />
