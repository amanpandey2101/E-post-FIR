...
function PrevAbout(){
    ...
    return(
        <div>
      <div className="2xl:container 2xl:mx-auto font-mono lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
            <div className="flex lg:flex-row flex-col justify-between gap-8 pt-12">
                ...
                <div className="w-full lg:w-8/12 lg:pt-8">
                    <div className="grid sm:grid-cols-2 grid-cols-1 lg:gap-4 shadow-lg rounded-2xl">
                        ...
                        <div className="p-4 pb-6 flex justify-center flex-col items-center" data-aos="zoom-in">
                            <img className="md:block h-60 md:h-[35vh] rounded-xl w-45 md:w-56" src={require('./images/anant.jpg')} alt="" />
            ...
            <div className="flex flex-col lg:flex-row justify-between gap-8">
                <div className="w-full lg:w-5/12 flex flex-col justify-center" data-aos="fade-right">
                    <h1 className="text-3xl lg:text-4xl font-bold leading-9 mt-4 text-gray-800 dark:text-white pb-4">Our Mission</h1>
                ...
                <div className="w-fit lg:w-8/12 " data-aos='zoom-out'>
