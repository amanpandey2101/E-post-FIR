                ...
                <div class="w-full lg:w-8/12 lg:pt-8">
                    <div class="grid sm:grid-cols-2 grid-cols-1 lg:gap-4 shadow-lg rounded-md">
                        <div class="p-4 pb-6 flex justify-center flex-col items-center">
                            <img class="md:block h-60 md:h-[35vh] rounded-xl w-60 " src={require('./images/amity_uniform_1-min-removebg-preview.png')} alt="" />
                        ...
                        <div class="p-4 pb-6 flex justify-center flex-col items-center">
                            <img class="md:block h-60 md:h-[35vh] rounded-xl w-72 object-contain" src={require('./images/anant.jpeg')} alt="" />
                            {/* <img class="md:hidden block object-cover object-bottom" src={require('./images/amity_uniform_1-min-removebg-preview.png')} alt="" /> */}
