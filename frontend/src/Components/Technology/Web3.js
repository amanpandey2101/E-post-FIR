        ...
        <section className="dark:bg-gray-800 dark:text-gray-100 ">
          <div className="container max-w-6xl mx-auto space-y-6 sm:space-y-12" >
            ...
            <a href="https://101blockchains.com/top-web3-advantages/" target={"_blank"} rel="noopener noreferrer" className="block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline  dark:bg-gray-900 shadow-2xl" data-aos="fade-up">
              <div className="p-6 space-y-2 lg:col-span-5">
                <h3 className="text-xl font-bold sm:text-4xl font-serif">Advantages of Web3.0</h3>
            ...
            <a href="https://inc42.com/resources/the-influence-of-web3-on-indian-internet-the-future-it-holds/z" target={"_blank"} rel="noopener noreferrer" className="block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline  dark:bg-gray-900 shadow-2xl" data-aos="fade-up">
              <div className="p-6 space-y-2 lg:col-span-5">
                ...
                <p className=' text-xl max-[600px]:text-sm'>Blockchain is a very powerful technology and many have been talking about its potential for almost a decade now. However, it still remains in its infancy and has its challenges. Thus, for Web3 to succeed, some of the problems the industry need to be overcome are: </p>
                <ul className='list-decimal text-lg pl-8'>
                  <li className='absolute md:left-28 font-bold md:text-2xl text-xl pt-5'>Slow transactions processing</li>
                  <p className='pt-16 max-[600px]:text-sm'>For Bitcoin-based blockchain, the processing speed is generally around 4.6 transactions per second, which falls short of the requirement that something as potentially huge as Web3 would require. </p>
                  <li className='absolute md:left-28 font-bold md:text-2xl text-xl pt-5'>Extremely energy-intensive and complex</li>
                    <p className='pt-20  md:text-xl text-sm '>It is said that the Bitcoin blockchain consumes about the same amount of energy as the whole of Finland. Plus, interacting with Web3 applications will require extra steps, software and education. This can be a hurdle to adoption. It’s much more complex compared to Web2, whose simplicity was the main reason behind its extreme popularity.  
                    </p>
                  <li className='absolute md:left-28 font-bold md:text-2xl text-xl pt-5'>Legal irregularities</li>
                    <p className='pt-16 md:text-xl text-sm'> One of the primary challenges of any use case of blockchain is the delay in government or regulatory bodies deciding the basic guidance and giving the high-level guidelines. While Bitcoin is a decade long use case, many countries, including India, are yet to have proper guidance around it. And till the time that happens, we won’t find Web3. 

 
                    </p>
                  <li className='absolute md:left-28 font-bold md:text-2xl text-xl pt-5'>Advantages for Creators</li>
                    <p className='pt-16 md:text-xl text-sm'>The arrival of web3 has signaled a promising opportunity for all content creators. Most content creators struggle to get the actual value for their work, owing to the intermediaries in different channels for reaching their audience. The key web 3.0 advantages from the features of tokenization and creator economy could serve notable benefits for creators. First of all, web3 would ensure decentralized control over security of digital assets such as tokens and data. On the other hand, creators would have complete control over the ownership of their work. At the same time, the creator economy could also help creators find new tools and marketplaces for expanding their reach. 
                    </p>
                  <li className='absolute md:left-28 font-bold md:text-2xl  pt-5'> Better Security</li>
                    <p className='pt-16 md:text-xl text-sm'>The final and the most important entry among web3 advantages would refer to the assurance of better security. Blockchain could provide the assurance of decentralization and cryptography for ensuring safeguards for user data. The consensus mechanisms and basic design of blockchain make it impervious to common security breaches. While 51% of attacks are still one of the possibilities for hacking web3 applications and systems, the evolution of new security measures and best practices can solve the challenges.
                    </p>
            ...
            <a href="https://gadgetstouse.com/blog/2022/12/07/what-is-e-rupi-how-it-works-banks-benefits/" target={"_blank"} rel="noopener noreferrer" className="block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline  dark:bg-gray-900 shadow-2xl" data-aos="fade-up">
              <div className="p-6 space-y-2 lg:col-span-5">
                <h3 className="md:text-2xl font-bold sm:text-4xl  font-serif">India's own Digital Currency</h3>
